...
1. student/general/learning-dna/
2. student/general/correction-notebook/
3. student/general/feynman-learning/
4. student/general/weekly-review/
...
1. [🧬 学习DNA](student/general/learning-dna/)：建立长期学习档案的授权底座
2. [❌ 智能错题本](student/general/correction-notebook/)：从“保存题目”升级为“定位错因”
3. [🎓 费曼学习法](student/general/feynman-learning/)：验证到底是真懂还是假懂
4. [📊 每周学习复盘](student/general/weekly-review/)：把过程沉淀成周报和成长线索
5. 按需加装 [⏰ IM智能提醒](student/general/im-reminder/) 或具体学科专项
