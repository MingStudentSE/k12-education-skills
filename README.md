...
在义务教育阶段，这套闭环还会把 2022 新课标的核心素养落到具体行为：不是泛泛说“培养思维能力”，而是明确这份材料里要观察什么、学生做什么任务能证明、做到什么算成功、下一步怎样调整。课标提供方向，学生的真实材料提供证据。
...
| 把“核心素养”写成口号或新版三维目标 | 转成可观测证据、最小学习任务、成功标准和下一轮反馈调整 |
...
当前基线：4 个 Product Module、61 个内部 playbook、58 个学习能力、63 条迁移映射、229 条四模块自然语言行为 fixture；其中 80 条同时属于 Learning 路由白盒子集，6 条同时属于课标证据子集。静态门只验证 fixture 契约；只有单独运行 [live 行为回归](docs/behavior-regression.md) 才形成行为通过证据。
