...
> 当前版本为 **V3.0**：4 个 Product Module、61 个内部 playbook、58 个学习能力、63 条旧入口映射、259 条四模块自然语言行为 fixture；其中 85 条同时属于 Learning 路由白盒子集，6 条同时属于课标证据子集，行为通过以单独的 live report 为证。
