...
1. **验题与验料**：确认题目、学生原步骤、目标年级和上下文是否足以判断；缺关键证据时先列最小追问。学生没有给自己的判断时，首轮只给一个定位线索和空白“材料主体—行为—候选原理—程序/意义”表，让学生先填一行并停止；不得先列完权利、原理、程序或答案骨架。
...
- 禁止在没有学生尝试时先完成整题再让学生填空；首轮空结构必须真的保留待学生完成的判断。
