...
> 本文件由原 `SKILL.md` 主体内容外移而来，用于保留学习DNA的长期画像结构、授权边界、情绪维度、协同白名单与操作细则。主文件只保留触发、流程、红线和索引；需要执行具体模板或字段定义时读取本文件对应章节。
...
1. **判断触发**：确认本次任务是否属于学习画像、长期偏好、成长图谱或学习证据编译；如果不是，先指出更合适的 SKILL 或仅做普通回答。
