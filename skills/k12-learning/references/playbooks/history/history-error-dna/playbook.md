...
- `references/history-anxiety-handling.md`：配套细则；当任务触及该文件名对应主题时读取。
- `references/history-concept-confusion-map.md`：配套细则；当任务触及该文件名对应主题时读取。
- `references/history-error-dimension-table.md`：配套细则；当任务触及该文件名对应主题时读取。
